<template>
  <v-container class="pa-6">
    <v-card class="mx-auto" max-width="100%">
      ...
      <!-- Add User Dialog -->
      <v-dialog v-model="showAddDialog" max-width="100%">
        <v-card>
          ...
          <v-card-text>
            <v-container>
              <v-row>
                ...
                <v-col cols="12">
                  <v-select label="Role" v-model="newUser.role" :items="roles" item-title="name" item-value="value" required></v-select>
                </v-col>
              </v-row>
            </v-container>
          </v-card-text>
          <v-card-actions>
            ...
            <v-btn style="background-color: #4fb9af; color: white;" variant="flat" @click="addUser">
              Save
            </v-btn>
          </v-card-actions>
        </v-card>
      ...
      <!-- Edit User Dialog -->
      <v-dialog v-model="showEditDialog" max-width="100%">
        <v-card>
          ...
          <v-card-text>
            <v-container>
              <v-row>
                ...
                <v-col cols="12">
                  <v-select label="Role" v-model="editedUser.role" :items="roles" item-title="name" item-value="value" required></v-select>
                </v-col>
              </v-row>
            </v-container>
          </v-card-text>
          <v-card-actions>
            ...
            <v-btn style="background-color: #4fb9af; color: white;" variant="flat" @click="saveEdit">
              Save
            </v-btn>
          </v-card-actions>
        </v-card>
